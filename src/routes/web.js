...
router.get('/translate-list/:id', translateList);
router.get('/translate-favorite-list/:id', favoriteList);
...
router.get('/flashcard-get-list/:id', loggedIn, getFlashCardList);
router.delete('/flashcard-delete-list', loggedIn, deleteFlashcard);
router.get('/flashcard-get-edit-list/:id/:editId', loggedIn, getEditFlashcard);
router.put('/flashcard-Edit-list', loggedIn, EditFlashcard);
router.get('/flashcard-get-detail/:userid/:id', loggedIn, getFlashcard);
